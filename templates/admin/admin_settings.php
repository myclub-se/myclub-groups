        ...
        if ( $myclub_groups_active_tab === 'tab1' ) {
            ...
            <ul>
                <li><strong><?php esc_attr_e( 'Calendar', 'myclub-groups' ) ?></strong>
                    - <?php myclub_groups_allow_code_html( __( 'The calendar block will display a group calendar. The available attributes are <code>post_id</code> which can be set to the WordPress post id of the group page that you want to get the calendar from or <code>group_id</code> which is the MyClub group id for the group page. The default is to use the current page. You can also use <code>show_subscribe_button</code> and set that to "1" if you want to display the subscribe button on a specific page. Use <code>height</code> to override the calendar height (e.g. "600", "auto", "100%"); leave empty to use the site default.', 'myclub-groups' ) ) ?>
                </li>
                <li><strong><?php esc_attr_e( 'Club calendar', 'myclub-groups' ) ?></strong>
                    - <?php myclub_groups_allow_code_html( __( 'The club calendar block will display the club calendar. You can use <code>show_subscribe_button</code> and set that to "1" if you want to display the subscribe button with the calendar. Use <code>height</code> to override the calendar height (e.g. "600", "auto", "100%"); leave empty to use the site default.', 'myclub-groups' ) ) ?>
                </li>
            ...
            <ul>
                <li><code>[myclub-groups-calendar]</code>
                    - <?php myclub_groups_allow_code_html( __( 'The calendar shortcode will display a group calendar. The available attributes are <code>post_id</code> which can be set to the WordPress post id of the group page that you want to get the calendar from or <code>group_id</code> which is the MyClub group id for the group page. The default is to use the current page. You can also use <code>show_subscribe_button</code> and set that to "1" if you want to display the subscribe button on a specific page. Use <code>height</code> to override the calendar height (e.g. "600", "auto", "100%"); leave empty to use the site default.', 'myclub-groups' ) ) ?>
                </li>
                <li><code>[myclub-groups-club-calendar]</code>
                    - <?php myclub_groups_allow_code_html( __( 'The club calendar shortcode will display the club calendar. You can use <code>show_subscribe_button</code> and set that to "1" if you want to display the subscribe button with the calendar. Use <code>height</code> to override the calendar height (e.g. "600", "auto", "100%"); leave empty to use the site default.', 'myclub-groups' ) ) ?>
                </li>
