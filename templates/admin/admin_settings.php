    ...
    <form method="post" action="options.php" id="myclub-settings-form">
        ...
        if( $active_tab === 'tab1' ) {
            ...
            <ul>
                ...
                <li><strong><?php esc_attr_e( 'Menu', 'myclub-groups' ) ?></strong> - <?php esc_html_e( "The menu block will display the group menu. This block doesn't require any attributes.", 'myclub-groups' ) ?></li>
                <li><strong><?php esc_attr_e( 'Navigation', 'myclub-groups' ) ?></strong> - <?php myclub_groups_allow_code_html( __( 'The navigation block will display the group page navigation. The available attributes are <code>post_id</code> which can be set to the WordPress post id of the group page that you want to get the navigation from or <code>group_id</code> which is the MyClub group id for the group page. The default is to use the current page.', 'myclub-groups' ) ) ?></li>
                <li><strong><?php esc_attr_e( 'News', 'myclub-groups' ) ?></strong> - <?php myclub_groups_allow_code_html( __( 'The news block will display the group page news. The available attributes are <code>post_id</code> which can be set to the WordPress post id of the group page that you want to get the news for or <code>group_id</code> which is the MyClub group id for the group page. The default is to use the current page.', 'myclub-groups' ) ) ?></li>
                <li><strong><?php esc_attr_e( 'Title', 'myclub-groups' ) ?></strong> - <?php myclub_groups_allow_code_html( __( 'The title block will display the group page title. The available attributes are <code>post_id</code> which can be set to the WordPress post id of the group page that you want to get the title from or <code>group_id</code> which is the MyClub group id for the group page. The default is to use the current page.', 'myclub-groups' ) ) ?></li>
            </ul>
            <?php
        } else { ?>
            ...
            <ul>
                ...
                <li><code>[myclub-groups-members]</code> - <?php myclub_groups_allow_code_html( __( 'The members shortcode will display the members for a group. The available attributes are <code>post_id</code> which can be set to the WordPress post id of the group page that you want to get the members from or <code>group_id</code> which is the MyClub group id for the group page. The default is to use the current page.', 'myclub-groups' ) ) ?></li>
                <li><code>[myclub-groups-menu]</code> - <?php esc_html_e( "The menu shortcode will display the group menu. This block doesn't require any attributes.", 'myclub-groups' ) ?></li>
                <li><code>[myclub-groups-navigation]</code> - <?php myclub_groups_allow_code_html( __( 'The navigation shortcode will display the group page navigation. The available attributes are <code>post_id</code> which can be set to the WordPress post id of the group page that you want to get the navigation from or <code>group_id</code> which is the MyClub group id for the group page. The default is to use the current page.', 'myclub-groups' ) ) ?></li>
                <li><code>[myclub-groups-news]</code> - <?php myclub_groups_allow_code_html( __( 'The news shortcode will display the group page news. The available attributes are <code>post_id</code> which can be set to the WordPress post id of the group page that you want to get the news for or <code>group_id</code> which is the MyClub group id for the group page. The default is to use the current page.', 'myclub-groups' ) ) ?></li>
