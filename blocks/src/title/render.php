                ...
                <div class="myclub-groups-title-information">
                    ...
                    if ( !empty( $contact_name ) ) { ?>
                        <div class="myclub-groups-information">
                            <div class="label"><?php echo esc_attr__( 'Contact person', 'myclub-groups' ); ?></div>
                            <div class="value"><?php echo esc_attr( $contact_name ); ?></div>
                        </div>
                    <?php }
                    if ( !empty( $phone ) ) { ?>
                        <div class="myclub-groups-information">
                            <div class="label"><?php echo esc_attr__( 'Telephone', 'myclub-groups' ); ?></div>
                            <div class="value"><a
                                        href="tel:<?php echo esc_attr( $phone ); ?>"><?php echo esc_attr( $phone ); ?></a>
                            </div>
                        </div>
                    <?php }
                    if ( !empty( $email ) ) { ?>
                        <div class="myclub-groups-information">
                            <div class="label"><?php echo esc_attr__( 'E-mail', 'myclub-groups' ); ?></div>
                            <div class="value"><a
                                        href="mailto:<?php echo esc_attr( $email ); ?>"><?php echo esc_attr( $email ); ?></a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
