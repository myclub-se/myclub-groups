...
class RestApi
{
     ...
     *
     * @param string $apiKey The API key to be used or null if it should be retrieved from the options.
     ...
     * @since 1.0.0
     */
    public function __construct( string $apiKey = null, string $pluginName, string $pluginVersion )
    {
